...
export const resourcesData: ResourceData[] = [
  {
    ...
    sections: [
      ...
      {
        heading: 'Which Countries Are Included in This Agreement?',
        paragraphs: [
          'As of April 2025, the United States has agreements with the following countries:',
        ],
        bullets: [
          'Ecuador',
          'Honduras',
      ...
      {
        heading: 'Why This Rule Matters for Asylum Seekers',
        paragraphs: [
          'This new requirement has significantly changed the asylum process and created additional legal barriers for immigrants. Previously, individuals could apply for asylum in the United States if they met the legal definition of persecution. Now, many applicants must prove that they either:',
        ],
        bullets: [
      ...
      {
        heading: 'Who Is Affected by the 2025 Asylum Rule?',
        paragraphs: [
      ...
      {
        heading: 'Understanding the Legal Basis of Asylum in the U.S.',
        paragraphs: [
          'To qualify for asylum in the United States, applicants must demonstrate that they have suffered persecution or have a well-founded fear of persecution based on:',
        ],
        bullets: [
          'Race',
          'Religion',
      ...
      {
        heading: 'Exceptions to the Third-Country Asylum Rule',
        paragraphs: [
        ...
        numbered: [
          'Lack of Access to a Safe Asylum System: If the third country does not provide a meaningful opportunity to apply for asylum, the requirement may not apply.',
          'Immediate Danger or Unsafe Conditions: If the individual would face harm, violence, or persecution in the third country, they may be exempt from having to apply there.',
          'Trafficking or Vulnerable Status: Victims of human trafficking, minors, or individuals with special vulnerabilities may qualify for exceptions.',
          'Denial of Asylum in Another Country: If the individual applied for asylum in a third country and was denied, they may still be eligible to apply in the United States.',
        ],
      },
      {
        heading: 'Challenges Created by the New Rule',
        paragraphs: [
          'The April 2025 asylum policy has introduced several challenges for asylum seekers.',
        ],
        numbered: [
          'Limited Resources in Third Countries: Countries like Honduras and Guatemala may lack the infrastructure to process large numbers of asylum applications effectively.',
          'Safety Concerns: Some designated countries may not be safe for all asylum seekers, especially those fleeing violence, persecution, or organized crime.',
          'Legal Complexity: The rule adds another layer of legal requirements, making it more difficult for individuals to navigate the asylum process without legal assistance.',
        ],
      },
      {
        heading: 'How This Rule Affects Border Crossings',
        paragraphs: [
          'Individuals arriving at the U.S. border without first applying for asylum in a designated country may face:',
        ],
        bullets: [
      ...
      {
        heading: 'Importance of Working with an Immigration Attorney',
        paragraphs: [
          'Navigating the new asylum rules requires legal knowledge, strategy, and careful preparation. An experienced immigration attorney in Los Angeles can:',
        ],
        bullets: [
      ...
      {
        heading: 'Real-Life Scenario: How the Rule Applies',
        paragraphs: [
          'Consider an individual fleeing violence in their home country who travels through Guatemala before reaching the United States. Under the new rule:',
        ],
        bullets: [
      ...
      {
        heading: 'Other Immigration Options to Consider',
        paragraphs: [
          'If asylum is unavailable under the new rule, other forms of immigration relief may still be possible. These may include:',
        ],
        bullets: [
      ...
      {
        heading: 'Key Takeaways About the April 2025 Asylum Rule',
        bullets: [
      ...
      {
        heading: 'How The Law Office of Todd Becraft Can Help',
        paragraphs: [
          'At The Law Office of Todd Becraft, we have decades of experience helping individuals navigate complex immigration laws. We provide:',
        ],
        bullets: [
      ...
      {
        heading: 'Contact Us for a Confidential Consultation',
        paragraphs: [
    ...
    cta: 'Have questions about the new asylum rules? Contact our Los Angeles immigration attorney for a confidential consultation.',
  },
  {
