...
import SpanishBlogPage from './components/pages/SpanishBlogPage';
import SpanishBlogPostPage from './components/pages/SpanishBlogPostPage';
      ...
      <div className="min-h-screen flex flex-col">
        ...
        <main className="flex-1">
          <Routes>
            ...
            <Route path="/es/blog/:slug" element={<SpanishBlogPostPage />} />
            <Route path="*" element={<HomePage />} />
          </Routes>
        </main>
        <Footer />
